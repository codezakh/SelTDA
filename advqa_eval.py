...
original_annotation_file = '/net/acadia10a/data/zkhan/advqa/v1_mscoco_val2017_advqa_annotations.json'
question_file = '/net/acadia10a/data/zkhan/advqa/v1_OpenEnded_mscoco_val2017_advqa_questions.json'

# This one doesn't have to exist, we create it from the original annotation file.
modified_annotations_file ='/net/acadia10a/data/zkhan/advqa/nb017_val2017_annotations_w_qtype.json'
...
if __name__ == "__main__":
    ...
    advqa_obj = VQA(
    annotation_file=modified_annotations_file,
