...
annotation_file = (
    "/net/acadia4a/data/zkhan/vqa-counterexamples/counterexamples_annotations.json"
)
question_file = (
    "/net/acadia4a/data/zkhan/vqa-counterexamples/counterexamples_questions.json"
)
