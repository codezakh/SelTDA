...
annotation_file = '/net/acadia4a/data/zkhan/vqa-rephrasings/v2_mscoco_valrep2014_humans_og_annotations.json'
question_file = '/net/acadia4a/data/zkhan/vqa-rephrasings/v2_OpenEnded_mscoco_valrep2014_humans_og_questions.json'
